...
The language attribute is referencing a variable containing the language code used to load the recaptcha script. Whenever this variable changes, recaptcha will be reloaded with the appropriate language.

####Note - You do not need to include a script reference to reCaptcha
...
>>>>>>> 9c4e5fd8057d2cc29fb30367f832fa671c018e53
